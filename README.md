...
- Performed customer churn analysis for a $12.41 billion telecommunications company, automating data cleaning and visualization for 400k+ rows, reducing manual reporting time by 94%.  
- Developed a forecasting churn for telecommunications company by creating a machine learning model that exceeded churn risk identification goals by 10%.
